<template>
  <div>
      ...
      <el-dialog
        ...
        <div>
          <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px">
            ...
            <el-input v-model.number="ruleForm2.phone" :disabled="true"/>
          </el-form-item>
    ...
    <el-button type="primary" @click="centerDialogVisible1 = false;submitForm('ruleForm2')">确 定</el-button>
  </span>
      </el-dialog>
      <hr>
      <el-row>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            axios.post('http://localhost:3000/userorderdis/perfect',{
              ...
              alert('修改成功')
              sessionStorage.setItem('sname',this.ruleForm2.name)
